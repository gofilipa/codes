...
*** TODO point to distinctions w/r/t cis and trans body in trajectory
...
apparently anchored to their sex-gender identities thoughout the show.
Nonetheless, I argue, these subjects, dating and falling in love from
behind a wall, sequestered from the sight of the other, undergo a
bifurcation within the body, which places them temporarility on the
"route to identity and bodily integrity" (6).

*** TODO here
To analyze this trajectory in LiB, created a tool that surfaces the
participants speech about their bodies and their experiences of
embodiment. Using the transcripts from the show, I built a text
generator that mimics the speech of the participants.[fn:1] I chose
this method because it abstracts from specific examples—the
transcripts of the show—to synthesize common and shared investments in
language. It allows me to study language in a “normalized” form, which
...
nature of the model, which will generate what is most plausible.[fn:3]
...
to “blinking” appears in the first meeting between a newly engaged
...
love_blind Github repository.
https://github.com/ANONYMIZED/love_blind. 2025.
...
[fn:2] The code and data for this project is published under
https://github.com/gofilipa/love_blind and the models are published
under https://huggingface.co/gofilipa 

[fn:3] While models are good at prediction, they are not at all good
