...
**** TODO Prosser, Jay. /Second Skins: The Body Narratives of Trannsexuality/, Columbia U Press, 1998. 
...
- Transsexuality is critiqued as a "literalization/deliteralization"
  of discourse: it either reinscribes or it transgresses the
  materiality of sex (13). It either reinscribes genitals as natural
  and primary, or it shows the unimportance of genitals, "we are all
  transsexuals and there are no transsexuals" (14).
  - Queer Studies building on poststructural critiques, where
    "materiality figures in reference to discourse and signification"
    (13). Critics like Foucault and Lacan who analyze institutions,
    ideologies, semiotics. "Materiality is our subject, but the body
    is not our object. The body is rather our route to analyzing
    power, technology, discourse, language" (13).
  
Butler's performativity is at odds with transsexuality. 
- gender crossing as metaphor is essential to theorizing
  performativity, but not in the actual material body of the crossing.
...
- "deliteralization of sex" - displaced from materiality to
  fantascized surface.
  - Butler misreads Freud to assume that the body is a projection from
    the ego, where in reality it is the opposite.
- on "Gender is Burning": according to Butler, "If Venus got her sex
  ...
  perversity" (49).
  - What makes Venus transgressive for Butler is also what gets her
    killed; she is not killed for being a homosexual man, but for
    being an incomplete woman.
  - "According to Butler, transgressive crossings can simultaneously
    reinscribe symbolic norms" (45). There is a "metaphorization of
    the transsexual body" (55).
