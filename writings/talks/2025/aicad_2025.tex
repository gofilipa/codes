...
\section{the value of neutrality in text-based data}
\label{sec:org3706649}

\subsection{interrogating neutrality}
\label{sec:org50159a4}
...
\begin{quote}
\begin{itemize}
\item how does the value of neutrality emerge in text-based data?
\item how does this value change in the age of automated text?
\end{itemize}
\end{quote}

\subsection{how does the value of neutrality emerge in text-based data?}
\label{sec:org184fd9b}
...
\subsection{SLIDE  how does neutrality as a value change in the age of automated text?}
\label{sec:orgd8913e1}
