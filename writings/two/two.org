...
contexts," including computational tools.[fn:3] From the field of
...
quantitative analysis.[fn:18] Using a loop, a person may /iterate/
...
one, and returns the shortest lemma found.[fn:4] In the python code,
...
“woman” to other words in the dataset.[fn:19] 
...
[fn:19] Known as the "GLoVe" dataset: Jeffrey Pennington, Richard
Socher, and Christopher D. Manning. 2014. GloVe: Global Vectors for
Word Representation.

[fn:18] Elements that are highly frequent, like articles,
...
[fn:4]  It uses the WordNet database, an electronic lexical database
