...
men," "men writing as women."[fn:24]
...
iteration. As I explain below, iteration is an essential component
that drives gender performativity, and by which it can also be
exploited.
...
(1996), explicitly aims to clarify how performativity is compulsory,
bounded on all sides by social norms in ways that delimit a subject's
agency. In /Bodies that Matter/, Butler explains that gender
performativity is a pre-determined procedure that /constitutes/
subjectivity: "there is no subject who decides on its gender.... on
the contrary, gender is part of what decides the subject" (ix).

In Butler's theory, iteration is a perpetual re-creation of the norm,
which effectively produces and re-produces power structures. As Butler
...
According to Butler, it is through performativity that "sexed" bodies
emerge: "'Sex' is not a simple fact or static condition of a body, but
a process whereby regulatory norms materialize 'sex' and achieve this
materialization through a forcible reiteration of those norms" (xii).
What appears as physical or biological category is actually a
"sedimentation" formed through repetition.

This sedimentation, whereby meaning is signified and re-signified
endlessly, is never complete. Which is way categories like sex require
constant repetition.
#+begin_quote
...
unexpected and extraneous into the performance, while nonetheless
staying within the boundary of the permissable.

** TODO 3

The boundary is, as it happens, a matrix. Essential to Butler's
thinking is the poststructuralist feminist theorist, Luce Irigaray and
her methodology for critiquing masculine language in her book, /The
Sex Which Is Not One/ (Irigaray 23). Irigaray argues that philosophers
like Plato, Aristotle, Descartes, and others, represent the feminine
through masculine terms, "on the basis of masculine parameters," which
is through the binary form (18). Irigaray argues that the Male/Female
binary (among other binaries) effectively /precludes/ the
representation of the other term, the feminine. Moreover, this
exclusion of the feminine, as it happens, effectively /produces/
another feminine within the terms of the masculinist system. In other
words, the feminine which has been excluded from the system, which
must be excluded in order for that system to work, into what Butler
calls the "constitutive outside," makes possible the creation of the
inner, "domesticated" feminine. This feminine, which is "unspeakable"
and unrepresentable, is the /matter/ from which the Male/Female binary
comes into intelligibility.
...
quantitative analysis.[fn:6] Using a loop, a person may /iterate/
...
“woman” to other words in the dataset.[fn:8] 
...
relationship, gender here is the /model/ which shows the algorithm to
be true.
...
binary in Woolf's /Orlando/. This practice iterates through various
...
the binary, but to show that these terms are /already/ inhabited by
that which they seek to exclude.

1

Subtitled /A Biography/, /Orlando/ takes real life as its source
...
characters.[fn:9] Orlando's character herself is modeled on Woolf's
...
which something is seen as significant" (17).[fn:11] Unlike Piper,
...
necessarily guided by the critic's own hand.[fn:12] Bode, who draws
...
(emphasis mine).[fn:13] Clement, whose multimodal work blends textual,
...
specific hermeneutical framework."[fn:14]
...
calculate the words "nearest" to the target words.[fn:15]
...
/repudiated/ by each term in the binary. Following Butler's reading of
...
is constituted by certain /exclusions/ which define its terms. In what
...
(Caughie, "Double Discourse, 44-45).[fn:17]
#+end_quote
...
switching from one sex to the other... as well as through the shifting
of her own rhetoric in this novel" (42);

Victoria L. Smith asserts that "what happens in the novel... and what
...
* Footnotes
[fn:24] Mandell, Laura. "Gender and Cultural Analytics:: Finding or
...
[fn:4] Distant reading is permeated by great ambition. In
...
[fn:6] Elements that are highly frequent, like articles,
...
('walked', 'walks' or 'walking') are converted into a root form.
...
[fn:8] Known as the "GLoVe" dataset: Jeffrey Pennington, Richard
Socher, and Christopher D. Manning. 2014. GloVe: Global Vectors for
Word Representation.

[fn:9] According to Christy L. Burns and Jane De Gay, Woolf re-works
...
[fn:10] “‘If I Saw You Would You Kiss Me?": Sapphism and the
Subversiveness of Virginia Woolf's Orlando.” /PMLA/, vol. 103, no. 1,
1988, pp. 24–34. www.jstor.org/stable/462459

[fn:11] Andrew Piper, /Enumerations/, University of Chicago
Press, 2019. page 18.

[fn:12] Karen Barad, in fact, takes up the concept of performativity
...
[fn:13] Bode, Katherine. "Computational Modeling: From Data
...
[fn:14] Clement, T. (2013). Distant Listening or Playing
...
[fn:17] Pamela Caughie. “Virginia Woolf’s Double Discourse.”
...
[fn:18] Jessica Berman, "Is the Trans in Transnational the Trans in
Transgender?" /Modernsim/Modernity/, vol 24, no 2, 2017. 217-244.

[fn:19] Channing, Jill. "Magical realism and gender variability in
Orlando." Virginia Woolf Miscellany, no. 67, 2005, p. 11+.

[fn:20] "'Ransacking the Language': Finding the Missing Goods in
Virginia Woolf's Orlando." Journal of Modern Literature, vol. 29 no.
4, 2006, pp. 57-75. Project MUSE, doi:10.1353/jml.2006.0050

[fn:21] De Gay, Jane. “Virginia Woolf’s Feminist Historiography In
Orlando.” /Critical Survey/, vol. 19, no. 1, 2007, p. 62+.

[fn:22] link to source Counter (python) code:
...
[fn:23] Criticism of the novel about gender and story.
