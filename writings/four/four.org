...
associations to generate new meaning.[fn:1]
...
that I deliberately trained[fn:2] to represent a progressive point of
...
on articles about gender from the ACLU[fn:3], align with what one
...
open licencses[fn:5]). The resulting text generators synthesized
...
laptop, over a single afternoon.[fn:6] Moreover, the dataset which I
...
then, these subjects in /LiB/ develop romantic feelings and
...
Butler notes in /Who’s Afraid of Gender?/, the contemporary far-right
...
** Appendix 1: ACLU and Heritage Model Outputs
** Appendix 2: Pods Model Outputs
...
** Appendix 3: Postpods Model Outputs
...
[fn:3] The training data and source code used to scrape the articles
...
[fn:6] For example, this project uses GPT-2, which is intially trained off
