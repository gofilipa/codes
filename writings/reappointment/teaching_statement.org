...
*** 1) close reading as critical practice:
...
In my INFO:664 class, I take a similar approach. For example, I
...
require formal writing assignments, such INFO:601, INFO: 657, and
...
Courses
- INFO 656: Machine Learning, Fall 2026.
  - This course offers an introduction to machine learning as a
...
- INFO 657: Digital Humanities. Spring 2026.
  - This course examines the history, theory, and practice of digital
...
- INFO 697: Special Topics - How to Build a Bot. Summer 2025.
  - This course offers a practical introduction to building bots in
    ...
    automation.
- INFO 664: Programming Cultural Heritage. Fall 2024, Spring 2025,
...
- INFO 601: Foundations of Information. Fall 2024, Spring 2025,
  Fall 2025, Spring 2026, Fall 2026.
  - This foundational course focuses on the intersection of people,
...
Workshops
- Text Processing with Python: Exploring /The Odyssey/. /The Data
  Storytelling Lab/ (/DSL/). Fall 2025, Fall 2026.
  - In this hands-on Python workshop, you’ll learn the fundamentals of
...
** mentoring & advising
In addition to the ~30 students that I teach directly each semester, I
...
members. The second group, The /Stacks/ Student Journal, which is
...
- First, I plan to develop a Python programming course that is
  ...
  focuses on using advanced tools like the /spaCy/ library in Python,
  ...
  skills.
- Second, I plan to develop a "Readings in Queer Studies" course.
...
** bank
  - active & experiential learning: students practice hands-on with
    knowledge they bring from experience
    - student investment in material: students must have a stake in what
      they are learning.
    - meeting the student where they are at: not making assumptions
